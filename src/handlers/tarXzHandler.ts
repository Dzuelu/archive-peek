...
/**
 * Handles reading .tar.xz (and .txz) archive files using tar-stream + xz-decompress.
 * Streams through the archive without writing anything to disk.
 */
export class TarXzHandler implements IArchiveHandler {
